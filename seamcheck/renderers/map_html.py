...
_COLUMNS = [
    ...
    ("redis_dead_assertion", "Dead assertion"),
...
const LAYER_KINDS = {
  ...
  database: new Set(["db_table", "db_column", "db_function", "db_policy",
                     ...
                     "cloud_function", "cloud_function_use"]),
  redis: new Set(["redis_key", "redis_invalidation", "redis_cleanup",
                  "redis_dead_assertion", "redis_key_use", "redis_ttl"]),
...
const COST_LANES = [
  ["Redis", new Set(["redis_key_use", "redis_key", "redis_invalidation",
                     "redis_cleanup", "redis_dead_assertion", "redis_ttl"])],
...
const TITLES = {overview: "Overview", map: "Map", files: "Files", report: "Send a report"};
const VIEWS = MENU
...
function overviewHtml() {
  return `<h2>Overview</h2>
    ...
    <div class="colophon">
      <p>Built by
        <a href="https://github.com/dardameiz" target="_blank" rel="noreferrer">dardameiz</a>
        — free, <a href="https://github.com/dardameiz/seamcheck" target="_blank" rel="noreferrer">MIT</a>.
        Got a finding wrong?
