...
|---|---:|---:|---:|---:|---:|
| **Flask** | 5 | 9,736 | 8,979 | **92%** | 93% |
| **Django** | 21 | 121,248 | 101,994 | **84%** | 92% |
| **Express** | 6 | 4,659 | 3,182 | **68%** | 68% |
| **FastAPI** | 5 | 4,958 | 2,871 | **57%** | 57% |
| **NestJS** | 4 | 3,578 | 1,750 | **48%** | 48% |
| **Next.js** | 6 | 3,533 | 1,635 | **46%** | 46% |
| **all** | **47** | **147,712** | **120,411** | **81%** | 87% |
...
backends are real and improving: Express went 46% → 68% and NestJS 32% → 48% in one
release, from four missing links in one mount chain. Precision is **55%** on hand-labelled
