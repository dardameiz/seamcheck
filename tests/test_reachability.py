...
from signal_map.extractors.reachability import discover_reachable_modules

FIXTURES_DIR = Path(__file__).parent / "fixtures"
# tests/ -> signal_map/ -> repo root. parents[3] would be the directory ABOVE the repo,
...
class ReachabilityTests(SimpleTestCase):
    def setUp(self):
        ...
        self.reached = discover_reachable_modules([root], str(REPO_ROOT), ["signal_map"])
